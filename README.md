...
This program (HT-AggNet) is designed to perform the real-time sensor-based activity recognition. The HT-AggNet includes a near-zero-cost layer stacking capable of stacking layers without increasing theoretical computation costs.
